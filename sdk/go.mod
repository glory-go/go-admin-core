...
require (
	...
	github.com/glory-go/go-admin-core v0.0.0-20220819063239-bc734ae7c7ca
	github.com/glory-go/go-admin-core/plugins/logger/zap v0.0.0-20220819072110-6c833e9cecc7
